...
const ProductsTable = () => {
  ...
  return (
    <motion.div
      className="bg-gray-200 bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 border border-[#4cbb2a] mb-8"
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="relative">
          <input
            ...
            className="bg-gray-100 text-black placeholder-gray-900 rounded-lg pl-10 pr-4 py-2 outline-blue-500  ring-2 focus:ring-blue-500"
